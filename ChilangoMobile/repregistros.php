...
<head>
	...
	<title>Resultado Registros</title>
</head>
...
echo "<h1 class='encabezado'>BIENVENIDO AL TOTAL DE REGISTROS:</h1><br><br><br>";
...
$n=1;
//Creación de archivo
if (!($da = fopen('registro.txt','w')))
	return;
//Impresión de los registros en panatalla y documento
echo "<big><big>";
while($n<= $nRows){
	echo "registro = ".$n."<br>";
	$fila=mysql_fetch_array($resultado);
	echo "Fecha:    ".$fila[0]."   Inicio:    ".$fila[1]."   Fin:   ".$fila[2]."   Costo:  ".$fila[3]."   Forma de pago:  ".$fila[4]."<br><br>";
	fprintf($da,"Fecha:%s Inicio:%s  Fin:%s   Costo:%s    Forma de pago:%s\r\n",$fila[0],$fila[1],$fila[2],$fila[3],$fila[4]);
	$n++;
